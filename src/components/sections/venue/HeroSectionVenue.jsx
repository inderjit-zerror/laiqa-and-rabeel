  ...
  return (
    <div ref={containerRef} className='w-full h-screen flex overflow-hidden  relative COLOR_BG_CREAM'>
      ...
      <div className='w-1/2 absolute top-[12%] left-1/2  justify-center items-center -translate-x-1/2 flex flex-col gap-4'>
        ...
        <h1 className=' uppercase Font_Q COLOR_TEXT_RED text-[6rem] leading-[7rem] max-sm:text-[15vw] max-sm:leading-[16vw] mt-[2vh] overflow-hidden ' ><span className='flex WEDMAIMTT2 translate-y-[100%]'> Oberoi Marrakech </span></h1>
      </div>
    </div>
  )
}
