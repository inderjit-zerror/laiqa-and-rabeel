...
const Hearts = () => {
    ...
    return (
        <div className='w-full h-[250vh] relative heart_cont cclt'>
            <div className='w-full h-screen overflow-hidden sticky flex flex-col COLOR_BG_Noise max-md:hidden justify-center top-0 left-0 COLOR_BG_RED COLOR_TEXT_CREAM uppercase'>
                {/* 1 */}
