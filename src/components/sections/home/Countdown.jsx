...
const Countdown = () => {
  ...
  return (
    <>
      ...
      {/* ================================================================ */}
      <section className="pb-[30vh] max-md:pb-[0vh] max-sm:pb-0 pt-42 max-sm:pt-0 w-full  h-[50vh] select-none mt-[15vh]  max-md:mt-0 flex flex-col justify-center items-center text-center">
