...
//               src={`/assets/IT2.png`}
//               alt="Img"
//               className="w-full h-full object-cover object-top max-sm:object-[80%_0%] stickyAnimation2"
//             />
...
//           {/* T1 */}
//           <div className="group w-1/4 h-[70%] max-md:h-fit max-md:w-[90%] [perspective:1000px]">
//             <div className="relative w-full h-full max-md:h-[50vh] transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
//               {/* FRONT */}
...
const FlipCard = ({ children, className }) => {
  ...
  const handleClick = () => {
    if (isTouchDevice()) setFlipped((prev) => !prev);
  };
  ...
  return (
    ...
    >
      <div
        className="relative w-full h-full max-md:h-[50vh] transition-transform duration-700"
        style={{
      ...
      <div className="w-full min-h-screen relative MMAINDDiv overflow-x-hidden">
        ...
        <div className="w-full h-screen max-md:h-fit COLOR_BG_RED relative z-100 flex max-md:flex-col p-20 max-md:gap-10 gap-10 px-10 justify-center items-center">
          ...
          <FlipCard className="w-1/4 h-[70%] max-md:h-fit max-md:w-[90%]">
            {/* FRONT */}
            <div
              className="absolute inset-0 bg-white border border-[#044BB2] py-10 px-5 flex flex-col justify-between"
            ...
            {/* BACK */}
            <div
              className="absolute inset-0 bg-[#044BB2] text-white flex items-center justify-center p-5"
              style={{
